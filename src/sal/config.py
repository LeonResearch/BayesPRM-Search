...
class Config:
    ...
    #model_path: str = "/home/huidong/.cache/huggingface/hub/models--meta-llama--Llama-3.2-1B-Instruct"
    gpu_memory_utilization: float = (
        0.8  # vllm is allocated 0.5 of GPU memory, the PRM uses the rest
    )
